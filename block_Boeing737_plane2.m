function [ p,numx,numy,xdim,ydim,x,y ] = block_Boeing737_plane1(r,c,a,cw,rw,sd,cd,lr,wall,nc,as,rs,cs,ws,space_front,space_back,space_above,space_below,x_exit,y_exit)
...
for i=((M-1)/2.0):(2*space_front+3*x_exit+3*r*rw+space_back)
    for j=1:N
      p(i,j) = as*(xdim - x(i));
    end
end

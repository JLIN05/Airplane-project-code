function [ p,numx,numy,xdim,ydim,x,y ] = Boeing737_plane_block_one2(r,c,a,cw,rw,sd,cd,lr,wall,nc,as,rs,cs,ws,space_front,space_back,space_above,space_below,x_exit,y_exit)
...
%middle exit
for i=((M-1)/2.0-space_back-x_exit+1):(M-1)/2.0+space_front+x_exit+lr
    for j=1:(N/2.0)

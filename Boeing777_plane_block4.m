function [ p,numx,numy,xdim,ydim,x,y ]=Boeing777_plane_block4(rb,re1,re2,cb,ce,ab,ae,cwb,cwe,rwb,rwe,sd,cd,lrb,lre,ncb,nce,as,rs,cs,space_front,space_back,x_exit)

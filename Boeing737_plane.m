function [ p,numx,numy,xdim,ydim,x,y ] = Boeing737_plane(r,c,a,cw,rw,sd,cd,lr,wall,nc,as,rs,cs,ws,space_front,space_back,space_above,space_below,x_exit,y_exit)
